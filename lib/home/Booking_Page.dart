...
class _BookingPageState extends State<BookingPage> with TickerProviderStateMixin {
      ...
      child: Column(
        ...
        children: [
          AnimatedDefaultTextStyle(
            ...
            style: TextStyle(
              color: selected ? (index == 0 ? Colors.red : accentGreen) : Colors.black87,
          ...
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              color: selected ? (index == 0 ? Colors.red : accentGreen) : Colors.transparent,
            ),
          )
        ],
      ),
  ...
  Widget _buildListView() {
    final List<Map<String, String>> data = activeTab == 0 ? urgentBookings : scheduledBookings;
    ...
    if (data.isEmpty) {
      return Center(
        child: Column(
          ...
          children: [
            Icon(activeTab == 0 ? Icons.flash_on : Icons.event_available, size: 48, color: Colors.grey[400]),
            const SizedBox(height: 12),
            Text(
              activeTab == 0 ? 'No urgent bookings right now' : 'No scheduled services',
  ...
  Widget _buildBookingCard(Map<String, String> item, bool isUrgent) {
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: isUrgent
            ? LinearGradient(
                colors: [Colors.red.withOpacity(0.18), Colors.red.withOpacity(0.12)],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              )
            : LinearGradient(
                colors: [primaryTeal.withOpacity(0.18), accentGreen.withOpacity(0.12)],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                item['status'] ?? '',
                                style: TextStyle(
                                  color: isUrgent ? Colors.red.shade700 : primaryTeal,
